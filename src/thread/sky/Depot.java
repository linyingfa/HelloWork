 ...
 * TODO(01) 生产者仅仅在仓储未满时候生产，仓满则停止生产。
 * TODO(02) 消费者仅仅在仓储有产品时候才能消费，仓空则等待。
 * TODO (03) 当消费者发现仓储没产品可消费时候会通知生产者生产。
 * TODO (04) 生产者在生产出可消费产品时候，应该通知等待的消费者去消费。
 */
// Demo1.java
// 仓库
public  class Depot {
...
//        消费者线程才能消费；消费者线程消费完产品之后，会通过notifyAll()唤醒同步锁上的所有线程，
//        包括“生产者线程”，即我们所说的“通知生产者进行生产”。
    }
}
